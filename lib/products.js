...
export const testimonials = [
  {
    name: "Maya R.",
    role: "Verified buyer",
    image: "/assets/product-makeup-8.png",
    text: "Everything felt thoughtful from the product page to the packaging. BubbleBud looks small-brand personal but polished.",
  },
  {
    name: "Claire T.",
    role: "Verified buyer",
    image: "/assets/product-purple-bouquet.jpg",
    text: "The bouquet arrived safely and looked premium. It was the easiest gift purchase I made this year.",
  },
  {
    name: "Nina K.",
    role: "Verified buyer",
    image: "/assets/product-laptop-14.jpg",
    text: "The laptop sleeve is lightweight, padded, and genuinely cute without feeling childish.",
  },
];
