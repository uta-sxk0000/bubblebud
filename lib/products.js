...
export const products = [
  ...
  },
  {
        ...
        options: [
          {
            label: "My Melody",
            images: [
              productAsset("quilted-floral-laptop-bag-14x10-inches-zipper-closure", "variant-my-melody.jpg"),
            ],
          },
          {
            label: "Teddy Bear",
            images: [
              productAsset("quilted-floral-laptop-bag-14x10-inches-zipper-closure", "variant-teddy-bear.jpg"),
            ],
          },
          {
            label: "Cinnamoroll",
            images: [
              productAsset("quilted-floral-laptop-bag-14x10-inches-zipper-closure", "variant-cinnamoroll.jpg"),
            ],
          },
          { label: "Pink Ribbon", image: productAsset("quilted-floral-laptop-bag-14x10-inches-zipper-closure", "variant-pink-ribbon.jpg") },
          { label: "Bunny", image: productAsset("quilted-floral-laptop-bag-14x10-inches-zipper-closure", "variant-bunny.jpg") },
        ],
      },
    ],
    ...
    gallery: [
      "variant-my-melody.jpg",
      "variant-teddy-bear.jpg",
      "variant-cinnamoroll.jpg",
      "variant-pink-ribbon.jpg",
      "variant-bunny.jpg",
      "01.jpg",
      "02.jpg",
      "03.jpg",
      ...
      "07.jpg",
      "08.jpg",
    ].map((file) => productAsset("quilted-floral-laptop-bag-14x10-inches-zipper-closure", file)),
  },
  {
    id: "makeup-8",
    ...
    variants: [
      {
        name: "Design",
        options: [
          { label: "Cherry", image: productAsset("portable-makeup-bag-travel-cosmetic-bag-8-inches", "variant-cherry.jpg") },
          { label: "Pink Peony", image: productAsset("portable-makeup-bag-travel-cosmetic-bag-8-inches", "variant-pink-peony.jpg") },
          { label: "Pink Floral", image: productAsset("portable-makeup-bag-travel-cosmetic-bag-8-inches", "variant-pink-floral.jpg") },
          { label: "Teddy Bear", image: productAsset("portable-makeup-bag-travel-cosmetic-bag-8-inches", "variant-teddy-bear.jpg") },
          { label: "Springknows", image: productAsset("portable-makeup-bag-travel-cosmetic-bag-8-inches", "variant-springknows.jpg") },
          { label: "Pink Ribbon", image: productAsset("portable-makeup-bag-travel-cosmetic-bag-8-inches", "variant-pink-ribbon.jpg") },
          { label: "Pink Bowknot", image: productAsset("portable-makeup-bag-travel-cosmetic-bag-8-inches", "variant-pink-bowknot.jpg") },
        ],
      },
    ],
    ...
    gallery: [
      "variant-cherry.jpg",
      "variant-pink-peony.jpg",
      "variant-pink-floral.jpg",
      "variant-teddy-bear.jpg",
      "variant-springknows.jpg",
      "variant-pink-ribbon.jpg",
      "variant-pink-bowknot.jpg",
      "01.png",
      "02.png",
      "03.png",
      "04.png",
  ...
  },
  {
        ...
        options: [
          {
            label: "Purple",
            images: [
              productAsset("variant-bouquets", "bouquet-16-purple.jpg"),
            ],
          },
          {
            label: "Pink",
            images: [
              productAsset("variant-bouquets", "bouquet-16-pink.jpg"),
            ],
          },
          {
            label: "Red",
            images: [
              productAsset("variant-bouquets", "bouquet-16-red.jpg"),
            ],
          },
          {
            label: "Blue",
            images: [
              productAsset("variant-bouquets", "bouquet-16-blue.jpg"),
            ],
          },
        ],
      },
    ...
    gallery: [
      ...
      productAsset("variant-bouquets", "bouquet-16-red.jpg"),
      productAsset("variant-bouquets", "bouquet-16-blue.jpg"),
      ...["01.jpg", "02.jpg", "03.jpg", "04.jpg", "05.png", "06.png", "07.jpg", "08.jpg", "09.jpg", "10.jpg", "11.jpg"].map((file) =>
        productAsset(
  ...
  },
  {
        ...
        options: [
          {
            label: "Pink",
            images: [
              productAsset("variant-bouquets", "bouquet-small-pink.jpg"),
            ],
          },
          {
            label: "Red",
            images: [
              productAsset("variant-bouquets", "bouquet-small-red.jpg"),
            ],
          },
        ],
      },
    ...
    gallery: [
      productAsset("variant-bouquets", "bouquet-small-pink.jpg"),
      productAsset("variant-bouquets", "bouquet-small-red.jpg"),
      ...["01.jpg", "02.jpg", "03.jpg", "04.jpg", "05.jpg", "06.jpg"].map((file) =>
  ...
  },
  {
        ...
        options: [
          {
            label: "Snowy Love",
            images: [
              productAsset("bubblebud-3d-led-night-light-with-erasable-pen", "variant-snowy-love.jpg"),
            ],
          },
          {
            label: "Lucky Love",
            images: [
              productAsset("bubblebud-3d-led-night-light-with-erasable-pen", "variant-lucky-love.jpg"),
            ],
          },
          {
            label: "Kitty",
            images: [
              productAsset("bubblebud-3d-led-night-light-with-erasable-pen", "variant-kitty.jpg"),
            ],
          },
          {
            label: "Circle",
            images: [
              productAsset("bubblebud-3d-led-night-light-with-erasable-pen", "variant-circle.jpg"),
            ],
          },
          {
            label: "Irregular",
            images: [
              productAsset("bubblebud-3d-led-night-light-with-erasable-pen", "variant-irregular.jpg"),
            ],
          },
        ],
      },
    ...
    gallery: ["variant-snowy-love.jpg", "variant-lucky-love.jpg", "variant-kitty.jpg", "variant-circle.jpg", "variant-irregular.jpg", "01.jpg", "02.jpg", "03.jpg", "04.jpg", "05.jpg", "06.jpg", "07.jpg", "08.jpg", "09.jpg", "10.jpg", "11.jpg", "12.jpg", "13.jpg", "14.jpg", "15.jpg"].map((file) =>
