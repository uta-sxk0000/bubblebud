...
export function getVariantOptions(product) {
  return getVariantGroups(product).flatMap((group) => group.options);
}
...
export function getDefaultVariant(product) {
  ...
  return formatVariantSelection(Object.fromEntries(groups.map((group) => [group.name, group.options[0]])));
}
...
export function getAllowedVariantValues(product) {
  ...
  for (const group of groups) {
    for (const option of group.options) {
      allowed.add(option);
      allowed.add(`${group.name}: ${option}`);
    }
  }

  if (groups.length) {
    allowed.add(formatVariantSelection(Object.fromEntries(groups.map((group) => [group.name, group.options[0]]))));
  }
...
export const products = [
  ...
  },
  {
    ...
    variants: [{ name: "Design", options: ["My Melody", "Teddy Bear", "Cinnamoroll", "Pink Ribbon", "Bunny"] }],
  ...
  },
  {
    ...
    variants: [{ name: "Design", options: ["Cherry", "Pink Peony", "Pink Floral", "Teddy Bear", "Springknows", "Pink Ribbon", "Pink Bowknot"] }],
  ...
  },
  {
    ...
    variants: [{ name: "Color", options: ["Purple", "Pink", "Red", "Blue"] }],
  ...
  },
  {
    ...
    reviewCount: 74,
    colors: ["Pink", "Red"],
    variants: [{ name: "Color", options: ["Pink", "Red"] }],
  ...
  },
  {
    ...
    variants: [{ name: "Style", options: ["Snowy Love", "Lucky Love", "Kitty", "Circle", "Irregular"] }],
  ...
  },
  {
    ...
    variants: [{ name: "Design", options: ["Pink Floral", "Springknows"] }],
